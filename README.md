...
<p>
  ...
  <img alt="tests" src="https://img.shields.io/badge/offline%20tests-4197%20passing-1D8102"/>
...
🟢 built & validated · 🟡 built, partial · 🟠 designed with loadable config · ⚪ design narrative only. **4197 offline tests pass** (+42 skipped when optional deps are absent or opt-in build/live checks are off).
...
| [`docs/TESTING.md`](docs/TESTING.md) | The 4197-test offline suite: layout, determinism, how to run |
...
├── tests/                offline unit + config tests (4197)     🟢
