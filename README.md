...
<p>
  ...
  <img alt="tests" src="https://img.shields.io/badge/offline%20tests-3987%20passing-1D8102"/>
...
🟢 built & validated · 🟡 built, partial · 🟠 designed with loadable config · ⚪ design narrative only. **3987 offline tests pass** (+6 skipped when optional deps absent).
...
| [`docs/TESTING.md`](docs/TESTING.md) | The 3987-test offline suite: layout, determinism, how to run |
...
├── tests/                offline unit + config tests (3987)     🟢
